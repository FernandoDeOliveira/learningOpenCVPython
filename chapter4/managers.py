...
class CaptureManager:
    ...
    def enterFrame(self):
        ...
        assert not self._enteredFrame, 'previous enterFrame() had no maching exitFrame()'
    ...
    def startWritingVideo(self, filename, encoding=cv2.VideoWriter_fourcc('I', '4', '2', '0')):
        """Start writting exited frames to a video file"""
...
class WindowManager:
    ...
    def processEvents(self):
        ...
        if self.keypressCallback is not None and keycode != -1:
            # Discard any non-ASCCII info encoded by GTK
            keycode &= 0xFF
